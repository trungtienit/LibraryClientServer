...
namespace Server
{
    class BookDB
    {
        ...
        public static String PATH_DB_XML = PATH_CONFIG + "\\BooksDB.xml";
        public static String PATH_DB_DIR = PATH_CONFIG + "\\Data";
        public static String PATH_CACHE = PATH_CONFIG + "\\Preview";
        public static String PATH_DB_USER_XML = PATH_CONFIG + "\\UsersDB.xml";
        ...
        public static void WriteNewDB()
        {
            ...
            books = serverManager.GetAllDataLocal(BookDB.PATH_DB_DIR, EXTENSIONS);
            try
            {
                XmlSerializer serializer = new XmlSerializer(typeof(List<Book>));
